export default {
  ...
  update: {
    title: 'Update - Check Remote and Local',
    check: 'Check',
    localRevision: 'Local Revision',
    remoteRevision: 'Remote Revision',
    incomingCount: 'Incoming Commits',
    localChangeCount: 'Local Changes',
    incomingTitle: 'Remote Not Updated Locally',
    incomingHint: 'These commits exist remotely and are not yet in this working copy',
    localTitle: 'Local Changes to Commit',
    localHint: 'These files are local changes in the current working copy',
    noIncoming: 'No incoming remote commits',
  },
  checkout: {
